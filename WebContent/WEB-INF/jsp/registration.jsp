		...
		<form action="Controller" method="POST">
			...
			<div class="row">
				<div class="col-xs-6 md-form">
					<input class="col-xs-2 form-control validate" placeholder="Doe" value="${lastName}" type="text" name="lastName" id="form1" required pattern="^[а-яА-ЯёЁіІїЇєЄa-zA-Z]+$"></input>
			...
			<div class="row">
				...
				<div class="md-form col-xs-4">
					<input class="col-xs-2 form-control validate" placeholder="+xx(xxx)xxx-xx-xx" type="text" value="${phone}" name="phone" id="form5" required pattern="^((8|\+7|\+38)[\- ]?)?(\(?\d{3}\)?[\- ]?)?[\d\- ]{7,10}$"></input>
			...
			<div class="row">
				<div class="col-xs-4">
					<mytag:customselect values="${subjects_list}" criterionForSelected="${subject_one}" selectClass="form-control" selectName="subject_one"/>
				</div>
				<div class="col-xs-4">
					<mytag:customselect values="${subjects_list}" criterionForSelected="${subject_two}" selectClass="form-control" selectName="subject_two"/>
				</div>
				<div class="col-xs-4">
					<mytag:customselect values="${subjects_list}" criterionForSelected="${subject_three}" selectClass="form-control" selectName="subject_three"/>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-4 md-form">
					<input class="col-xs-4 form-control validate" placeholder="200.00" type="text" value="${mark_one}" name="mark_one" required pattern="(\d{3})+(\.\d{1,3})*"></input>
				</div>
				<div class="col-xs-4 md-form">
					<input class="col-xs-4 form-control validate" placeholder="200.00" type="text" value="${mark_two}" name="mark_two" required pattern="(\d{3})+(\.\d{1,3})*"></input>
				</div>
				<div class="col-xs-4 md-form">
					<input class="col-xs-4 form-control validate" placeholder="200.00" type="text" value="${mark_three}" name="mark_three" required pattern="(\d{3})+(\.\d{1,3})*"></input>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-8 md-form">
					<input class="form-control validate" placeholder="200.00" type="text" value="${certificate}" name="certificate" id="form9" required pattern="(\d{3})+(\.\d{1,3})*"></input>
